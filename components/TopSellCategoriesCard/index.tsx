...
export const TopSellCategoriesCard: FC<ITopSellCategoriesProps> = ({
  ...
  return (
    ...
    >
      ...
      <div className="absolute left-[-3%] bottom-[0%] top-[auto] w-[70%] h-[70%] inset-0 transition-transform duration-300 ease-in-out transform group-hover:scale-125 group-hover:rotate-[-10deg]">
